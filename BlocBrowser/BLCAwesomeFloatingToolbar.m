...
-(instancetype)initWithFourTitles:(NSArray *)titles{
    ...
    // First, call the superclass (UIview)'s initializer, to make sure we do all the setup first.
    self = [super init];
    
    if (self) {
        
        self.currentTitles = titles;
        self.colors = @[[UIColor colorWithRed:199/255.0 green:158/255.0 blue:103/255.0 alpha:1],
